<div>
    ...
    @if(count($entradas))
        ...
        <div class="rounded-lg shadow-xl mb-5 p-4 font-thin md:flex items-center justify-between bg-white">
            ...
            <p class="text-xl font-extralight">Se encontraron: {{ number_format($entradas->total()) }} registros con los filtros seleccionados.</p>
            ...
            <table class="rounded-lg w-full">
                ...
                <tbody class="divide-y divide-gray-200 flex-1 sm:flex-none">
                    ...
                    @foreach($entradas as $entrada)
                        ...
                        <tr class="text-sm  text-gray-500 bg-white flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0 text-center" wire:key="row-{{ $entrada->id }}">
