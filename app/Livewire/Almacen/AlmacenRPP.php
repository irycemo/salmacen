...
class AlmacenRPP extends Component
{
    ...
    public function render()
    {
        ...
        $articulos = ArticuloDisponible::where('ubicacion', 'rpp')
        ...
        return view('livewire.almacen.almacen-r-p-p', compact('articulos'))->extends('layouts.admin');
